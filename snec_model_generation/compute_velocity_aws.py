...
def compute_vel(Mzams):
    ...
    profile_k14 = os.path.join('..', 'sukhbold_profiles_kepler', 's'+str(Mzams)+'_presn')
    mass_profile, Fe_mass_fraction = np.loadtxt(profile_k14,usecols=(1,30),unpack=True,skiprows=2)
